            ...
            <section className="relative mb-6 overflow-hidden rounded-[32px] bg-gradient-to-br from-teal-600 via-emerald-600 to-teal-700 p-6 text-white shadow-[0_12px_40px_rgba(13,148,136,0.35)] sm:p-8">
                    ...
                    <div className="relative flex flex-wrap items-center justify-between gap-6">
                        <div className="min-w-0 max-w-2xl">
                            ...
                            <p className="mt-2 text-sm font-medium text-emerald-50 sm:text-base leading-relaxed">
                                {role === 'admin'
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            />
                            <StatPill
                                icon={<TreePine className="size-5 text-emerald-200" />}
                ...
                <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1fr_340px]">
                    ...
                    <div className="min-w-0 space-y-6">
                        ...
                        >
                            {recent_pending_reviews.length > 0 ? (
                                    ...
                                    {recent_pending_reviews.map((item) => (
                                        ...
                                        >
                                            <div className="flex items-center gap-3.5 min-w-0">
                                                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-500 font-bold text-white text-lg shadow-sm">
                                ...
                                <div className="flex flex-col items-center justify-center rounded-[24px] bg-emerald-50/40 p-8 text-center border border-dashed border-emerald-200">
                                    ...
                                    <p className="mt-1 max-w-sm text-xs font-medium text-slate-500">
                                        Tidak ada antrian validasi santri saat ini. Terima kasih atas dedikasi pembinaan Ustadz!
                                    </p>
                                </div>
                            )}
                        </Section>
                    ...
                    <aside className="space-y-6 xl:sticky xl:top-4 xl:self-start">
                        ...
                        {/* Tips & Panduan Ustadz */}
                        <div className="rounded-[28px] bg-white p-5 shadow-[0_8px_30px_rgba(16,58,58,0.08)]">
                            <h2 className="flex items-center gap-2 text-base font-extrabold text-slate-700 mb-4">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-start gap-3 rounded-2xl bg-teal-50/70 p-3.5">
                                    ...
                                    <div className="text-xs">
                                        ...
                                        <p className="mt-0.5 text-slate-600 leading-snug">
                                            Gunakan rekaman audio santri untuk mengevaluasi kejujuran dan pemahaman moral secara utuh.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3 rounded-2xl bg-sky-50/70 p-3.5">
                                    ...
                                    <div className="text-xs">
                                        ...
                                        <p className="mt-0.5 text-slate-600 leading-snug">
                                            Apresiasi setiap penalaran baik yang disampaikan santri untuk membakar semangat karakter mereka.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="rounded-[28px] bg-gradient-to-br from-slate-800 to-slate-900 p-5 text-white shadow-[0_8px_30px_rgba(15,23,42,0.15)]">
                            ...
                            <p className="mt-3 text-xs text-slate-300 leading-relaxed">
                                Anda memiliki akses penuh untuk membimbing santri dan memvalidasi perkembangan moral mereka.
                            </p>
                        </div>
                    </aside>
                </div>
...
function StatPill({
    ...
    return (
        <div className="flex items-center gap-2.5 rounded-full bg-white/15 px-4 py-2 text-white backdrop-blur-md shadow-sm transition-transform hover:scale-105">
            {icon}
            <div>
                <div className="text-sm font-extrabold leading-none">{value}</div>
                <div className="text-[10px] font-semibold text-emerald-100">{label}</div>
            </div>
        </div>
    );
}
...
function Section({
    ...
    return (
        <section className="rounded-[28px] bg-white p-5 sm:p-6 shadow-[0_8px_30px_rgba(16,58,58,0.08)]">
            <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
                ...
                {actionLabel && actionHref && (
                    <Link
                        href={actionHref}
                        className="flex items-center gap-1 text-xs font-extrabold text-emerald-600 hover:text-emerald-700 transition-colors"
                    >
                        {actionLabel}
                        <ChevronRight className="size-4" />
                    </Link>
